function [numEpisode, elapsedTime, bestRob, bestXout, bestYout] = falsify_RL_dqn(expParams)
...
%     else
    ...
    py.DQN_agent.train(expParams.option,...
    ...
    for numEpisode=1:expParams.maxEpisodes
        ...
        py.DQN_agent.stop_episode_and_train(state(end, :), exp(- robustness) - 1);
        ...
        py.DQN_agent.save(strcat('./agents/',expParams.simlink_model));
    end
    elapsedTime = toc;
