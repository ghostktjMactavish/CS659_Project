function [numEpisode, elapsedTime, bestRob, bestXout, bestYout] = falsify_RL_catdqn(expParams)

    py.CatDQN_agent.hello();
    % Load Simulink Model
...
%     else
    ...
    py.CatDQN_agent.train(expParams.option,...
    ...
    for numEpisode=1:expParams.maxEpisodes
        ...
        py.CatDQN_agent.stop_episode_and_train(state(end, :), exp(- robustness) - 1);
        ...
        py.CatDQN_agent.save(strcat('./agents/',expParams.simlink_model));
    end
    elapsedTime = toc;
