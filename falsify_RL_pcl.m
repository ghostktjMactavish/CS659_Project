function [numEpisode, elapsedTime, bestRob, bestXout, bestYout] = falsify_RL_pcl(expParams)
...
%     else
    ...
    py.pcl_agent.train(expParams.option,...
    ...
    for numEpisode=1:expParams.maxEpisodes
        ...
        py.pcl_agent.stop_episode_and_train(state(end, :), exp(- robustness) - 1);
        ...
        py.pcl_agent.save(strcat('./agents/',expParams.simlink_model));
    end
    elapsedTime = toc;
